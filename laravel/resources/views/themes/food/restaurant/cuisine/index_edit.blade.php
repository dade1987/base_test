...
@endphp
    @include('pub_theme::restaurant.edit.hero',['row'=>$restaurant])
    @include('pub_theme::layouts.default.index_edit.tabs',['panel'=>$restaurant_panel])
        ...
        <div class="row">
          <div class="col-lg-8">
            @foreach($rows as $cuisine)
                @php
                    $cuisine_panel=Panel::get($cuisine)->setParent($restaurant_panel);
                @endphp
                @include('pub_theme::restaurant.cuisine.index_edit.item',['cuisine_panel'=>$cuisine_panel,'cuisine'=>$cuisine])
            @endforeach
