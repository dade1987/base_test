...
return [
    ...
    // smarty plugins
    'plugins_paths' => [
        base_path('Modules/Theme/Resources/smarty/plugins'),
        //base_path('Modules/Ew/Resources/smarty/plugins'),
    ],

    // smarty configure
    'config_paths' => [
        base_path('Modules/Theme/Resources/smarty/config'),
        //base_path('Modules/Ew/Resources/smarty/config'),
    ],
